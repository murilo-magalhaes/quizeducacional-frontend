...
const CreateGameDialog: React.FC<DialogProps> = (props: DialogProps) => {
    ...
    return <Dialog className={'border-primary p-fluid grid formgrid'} visible={props.visible} onHide={props.onClose}
        ...
        <div className={'field col-12'}>
            ...
            <InputNumber showButtons placeholder={'Ex.: 5'} min={1} value={game.qntQuestions}
                         onChange={e => setGame({...game, qntQuestions: Number(e.value)})}/>
        </div>
